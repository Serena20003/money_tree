...
with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
    ...
    all_articles = list(executor.map(fetch_google_news, STOCK_SYMBOLS))
...
# ✅ Save to CSV
df_sentiment.to_csv("stock_sentiment_data.csv", index=False)


print("\n✅ Sentiment Data saved successfully as 'stock_sentiment_data.csv'!")
